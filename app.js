...
app.get("/",function(req,res){
	...
	const url = "https://api.openweathermap.org/data/2.5/weather?q=London,uk&appid=cb2853fd0e1cd74171349132b725e139";
	...
	https.get(url,function(response){
		...
		response.on("data",function(data){
			const weatherData = JSON.parse(data)
				...
				res.send("The tempearature in london is " +temp+" degree celcius");
	...
	https.get(url,function(response){
		...
		response.on("data",function(data){
			const weatherData = JSON.parse(data)
				const temp = weatherData.main.temp
				const weatherDesciption = weatherData.weather[0].description 
				res.send("<h1>The tempearature in london is " +temp+" degree Celcius</h1>");
				console.log(weatherDesciption);
	...
	https.get(url,function(response){
		...
		response.on("data",function(data){
			const weatherData = JSON.parse(data)
				...
				res.write("<h1>The tempearature in london is " +temp+" Kelvin.</h1>");
